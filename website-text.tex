...
A PhD candidate at the University of Toronto and doctoral researcher at Berkeley Lab (NERSC).

\paragraph{Bio Paragraph 2}
I'm a physicist and machine learning researcher working in AI for science. My research has been/is focused on using physics-inspired theory and physics data to understand neural network behavior, building foundation models that transfer across scientific domains, and developing AI tools to automate scientific discovery.
...
\textbf{Description:} Leveraging the unique properties of physics datasets, where we have access to controllable data generation and understand data symmetry and structure, to probe the internal mechanisms of deep neural networks.
...
\textbf{Description:} Using tools from statistical mechanics and effective field theory to predict how neural network ensembles behave, deriving scaling laws for uncertainty quantification without exhaustive training.
...
\textbf{Description:} Developing ML methods for the goal of theory inversion. Parameter estimation with Uncertainty Quantification, Simulation Emulation, and Automating Theory Writing, for quick exploration of theory space.
...
\textbf{Description:} Using tools from statistical mechanics and effective field theory to predict how neural network ensembles behave. Can we derive scaling laws for ensemble uncertainty without training thousands of models? Our work shows that physics-inspired theory can predict initialization-driven ensemble variance from first principles.
