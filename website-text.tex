...
\paragraph{Subtitle}
PhD candidate at the University of Toronto and Vector Institute. Building foundation models for science at Berkeley Lab/NERSC.
...
I am a PhD candidate at the University of Toronto and Vector Institute advised by Prof.Yoni Kahn and doctoral researcher at Berkeley Lab (NERSC) advised by Wahid Bhimji and Benjamin Nachman
...
\textbf{Tag:} Physics for AI\\
\textbf{Title:} Physics Data for Understanding ML\\
\textbf{Description:} Leveraging the unique properties of physics datasets (access to controllable data generation and known data symmetry and structure) to probe the internal mechanisms of deep neural networks.
...
\begin{enumerate}
    ...
    \item \textbf{Generative Models on Phase Space}\\
...
\begin{itemize}
    \item \textbf{2025--Present:} PhD, Physics --- University of Toronto and Vector Institute
    \item \textbf{2023--2025:} MSc, Physics --- University of Illinois Urbana-Champaign
    \item \textbf{2019--2023:} B.S., Computational Physics / B.A., Applied Mathematics \& Philosophy --- Rice University
\end{itemize}
...
\begin{itemize}
    \item \textbf{2026:} NSERC Doctoral Canadian Graduate Research Scholarship (CGRS D)
