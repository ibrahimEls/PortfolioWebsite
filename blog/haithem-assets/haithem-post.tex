...
\videoplace{tree-growth}{The global signature tree as it is grown: the
analytic observables split the LLaM's viable regions first, then the LLM-agent
nodes take over the leaves nothing computed so far can tell apart.}
