...
\postexcerpt{Most of the parameter space of any beyond-the-Standard-Model
theory is already dead. Framing the hunt for what survives as a search
problem, and letting LLM agents propose the observables that carve it up.}
